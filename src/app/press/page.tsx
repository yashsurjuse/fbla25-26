      ...
      <section className="mx-auto w-full max-w-5xl px-4 pt-16 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            <h2 className="font-display text-3xl font-semibold border-b border-black/10 pb-4 text-black">Latest Press Releases</h2>
            
            {pressReleases.map((pr) => (
              <Link key={pr.slug} href={`/press/${pr.slug}`} className="block bg-white p-6 rounded-2xl shadow-sm border border-black/5 hover:border-black/20 hover:shadow-md transition-all cursor-pointer group">
                <div className="text-sm font-semibold text-black/50 mb-2">{pr.date}</div>
                <h3 className="font-display text-2xl font-semibold text-black group-hover:text-blue-700 transition-colors mb-3">
                  {pr.title}
                </h3>
          ...
          <div className="space-y-8">
            <div className="bg-black text-white p-8 rounded-3xl">
              ...
              <div className="space-y-4 text-white/80">
                <div>
                  ...
                  <a href="mailto:communications@metmuseum.org" className="hover:underline hover:text-white">communications@metmuseum.org</a>
                  <div>212-570-3951</div>
                </div>
                <div>
                  <div className="font-semibold text-white">Image Requests</div>
                  <a href="mailto:image.requests@metmuseum.org" className="hover:underline hover:text-white">image.requests@metmuseum.org</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#ece7de] p-8 rounded-3xl">
              ...
              <ul className="space-y-4 text-black/80 font-medium">
                <li>
                  <a href="/press/image-library" className="hover:text-black hover:underline flex items-center gap-2">
                    <span>&rarr;</span> High-Res Image Library
                  </a>
                </li>
                <li>
                  <a href="/press/filming-policy" className="hover:text-black hover:underline flex items-center gap-2">
                    <span>&rarr;</span> Filming & Photography Policy
                  </a>
                </li>
                <li>
                  <a href="/about/history" className="hover:text-black hover:underline flex items-center gap-2">
                    <span>&rarr;</span> Fact Sheet & History
                  </a>
                </li>
                <li>
                  <a href="mailto:communications@metmuseum.org?subject=Press%20Pass%20Request" className="hover:text-black hover:underline flex items-center gap-2">
